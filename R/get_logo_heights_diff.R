#' @title Get heights of logos in nlogomaker() using differences of the PWM with background.
#'
...
#' scales respectively using differences of the PWM with background.
#'
...
get_logo_heights_diff <- function(table, epsilon = 0.01, bg = NULL,
