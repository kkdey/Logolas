#' @title Get heights of logos in nlogomaker() using Information criterion with splitting
#' of ratios.
#'
...
get_logo_heights_ic_ratio <- function(table, alpha = 1, epsilon = 0.01, bg = NULL, opt = 1,
