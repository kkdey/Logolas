...
#' log odds scale splitting of ratios
#'
...
#' scales respectively using Information criterion and log odds scale split.
#'
...
#' ic-log-odds approach to EDLogo.
#'
...
#' colnames(m) = 1:12
#' m=m/8
#' get_logo_heights_ic_log_odds(m, alpha = 1, hist = FALSE)
#'
#' @export


get_logo_heights_ic_log_odds <- function(table, alpha = 1, epsilon = 0.01, bg = NULL, opt = 1,
