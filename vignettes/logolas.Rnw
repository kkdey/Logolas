...
\begin{figure}[h]
\begin{center}
<<standard_logo, cache=FALSE, eval=TRUE, warning=FALSE, fig.show="asis", dpi=144, fig.width=6, fig.height=5, out.width="6in", out.height="5in">>=
...
<<diff_features, cache=FALSE, eval=TRUE, warning=FALSE,  fig.show="asis", dpi=144, fig.width=6, fig.height=5, out.width="6in", out.height="5in">>=
...
<<entropy, cache=FALSE, eval=TRUE, warning=FALSE,  fig.show="asis", dpi=144, fig.width=8, fig.height=6, out.width="6in", out.height="5in">>=
...
<<ggplot2, cache=FALSE, eval=TRUE, warning=FALSE,  fig.show="asis", dpi=144, fig.width=6, fig.height=5, out.width="6in", out.height="5in">>=
...
<<edlogo, cache=FALSE, eval=TRUE, warning=FALSE,  fig.show="asis", dpi=144, fig.width=6, fig.height=5, out.width="6in", out.height="5in">>=
...
seekViewport(paste0("plotlogo", 1))
logomaker(pwm,color_profile=color_profile,frame_width = 1,pop_name = 'Logo',control = list(gap_ylab=3.5), newpage = FALSE)

seekViewport(paste0("plotlogo", 2))
nlogomaker(pwm,logoheight = 'log',color_profile = color_profile,pop_name = 'EDLogo',control = list(gap_ylab=3.5), newpage = FALSE)
...
<<edlogo_opts,message=FALSE,eval=TRUE, warning=FALSE,  fig.show="asis", dpi=144, fig.width=6, fig.height=5, out.width="6in", out.height="5in">>=
