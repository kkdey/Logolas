...
\vspace{1em}
\textbf{\Logolas{} version:} 0.99.14 \footnote{This document used the vignette from \Bioconductor{} package \Biocpkg{CountClust, DESeq2} as \CRANpkg{knitr} template}
\end{abstract}
...
\hlkwd{logomaker}\hlstd{(himalayan_fauna_3_clusters,}
          ...
          \hlkwc{frame_width} \hlstd{=} \hlnum{1}\hlstd{,}
          \hlkwc{ic.scale} \hlstd{=} \hlnum{TRUE}\hlstd{,}
          \hlkwc{alpha}\hlstd{=}\hlnum{200}\hlstd{,}
...
## [1] Logolas_0.99.14 knitr_1.15.1   
## 
